const TECH_LOGOS = [
  {
    name: "JavaScript",
    svg: `
      <svg viewBox="0 0 64 64" aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg">
        <rect width="64" height="64" rx="12" fill="#F7DF1E" />
        <text x="32" y="44" text-anchor="middle" font-size="28" font-family="Inter, sans-serif" fill="#000">JS</text>
      </svg>
    `,
  },
  {
  ...
  },
  {
    ...
    svg: `
      <svg viewBox="0 0 64 64" aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="32" y="42" text-anchor="middle" font-size="26" font-family="Inter, sans-serif" fill="#fff">N</text>
      </svg>
    `,
  },
  {
  ...
  },
  {
    ...
    svg: `
      <svg viewBox="0 0 64 64" aria-hidden="true" role="img" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M16 42c6-4 12-8 20-8s14 4 20 8" stroke="#fff" stroke-width="4" fill="none" />
        <path d="M16 30c6-4 12-8 20-8s14 4 20 8" stroke="#fff" stroke-width="4" fill="none" />
      </svg>
    `,
  },
];
      ...
      <div className="flex items-center gap-4 overflow-hidden">
        ...
        <div className="flex gap-4 flex-wrap items-center flex-1 overflow-hidden">
          {TECH_LOGOS.map((tech) => (
            <span
              key={tech.name}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-white/5 border border-white/10"
